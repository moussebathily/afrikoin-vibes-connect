        ...
        <Card className="max-w-md mx-4">
          <CardContent className="p-6 text-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Veuillez vous connecter pour voir vos réservations Tabaski.
            </p>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Vous n'avez pas encore réservé de bétail pour la Tabaski.
              </p>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {reservation.livestock_breed} • {reservation.livestock_weight || 'N/A'}
                        </p>
                        <p className="text-sm text-muted-foreground">
                          Vendeur: {reservation.seller_name}
                        </p>
                      </div>
                      <div className="text-right">
                        <span className="text-xl font-bold text-primary">
                          {reservation.livestock_price.toLocaleString()}
                        </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm pl-6">
                          {format(new Date(reservation.delivery_date), 'EEEE d MMMM yyyy', { locale: fr })}
                        </p>
                      </div>
