...
export function AIDescriptionEnhancer({ 
  ...
  const handleEnhancement = async () => {
    ...
    const enhancementResult = await enhanceDescription(description, category, price, language)
          ...
          <div className="space-y-4 pt-4 border-t">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium">Description améliorée :</span>
            ...
            {result.suggested_keywords?.length > 0 && (
              <div className="space-y-2">
                <span className="text-sm font-medium">Mots-clés suggérés :</span>
